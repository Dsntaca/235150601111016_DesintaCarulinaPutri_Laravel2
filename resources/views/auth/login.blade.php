...
<body
    ...
    <h1 class="text-4xl font-bold text-custom-text mb-4">Login</h1>
    <p class="text-lg mb-6 text-custom-text">Welcome back to Blogs</p>
    ...
    <p class="mt-4 text-sm">
        Don't have an account? <a href="{{ route('register') }}" class="text-custom-bg hover:underline">Sign up</a>
    </p>
</body>
